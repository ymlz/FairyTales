...
<footer id="footer" role="contentinfo">
    <div class="container-fluid">
        <div class="row">
        <div class="col-12">
            &copy; <?php echo date('Y'); ?> <a href="<?php home_url(); ?>"><?php bloginfo(‘name’); ?></a>.
            <?php _e('Using <a target="_blank" href="https://wordpress.org/">WordPress</a> & <a target="_blank" href="https://langzi.xin/">FairyTales</a>'); ?>.
        </div>
        </div>
    </div>
</footer>
...
<script src="<?php echo get_template_directory_uri(); ?>/js/zoom-vanilla.min.js"></script>
<script>
